    ...
    return (
      <section className="bg-white mt-20 max-w-2xl px-6 text-center mx-auto">
        ...
        <p className="text-gray-600 mt-4">
          I'm a software development and a web designer student with
          intermediate level experience, currently I'm specializing in web
          technologies and UI design, and with little knowledge in mobile and
