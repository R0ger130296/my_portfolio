...
class HappyBirthday_En extends Component {
  ...
  confirmationMessage() {
    Swal.fire({
      ...
      if (result.value) {
        Swal.fire(
          "Confirmo tú confirmación! :D ^^ jajaj",
  ...
  render() {
    ...
    return (
      <div className="h-screen w-screen flex flex-col justify-center items-center">
        ...
        <div
          className="flex xl:flex-row lg:flex-row flex-col w-full h-full bg-cover"
          style={{
        ...
        >
          {this.state.agreement ? (
            <>
              <div className="flex flex-col xl:w-1/4 lg:w-1/4 w-full">
                <div className="flex flex-wrap h-full justify-center items-center">
                  <img
                    src="/freetimeideas/carrousel/1.jpg"
                    alt=""
                    className="h-48 w-48 px-2"
                  />
                  <img
                    src="/freetimeideas/carrousel/2.jpg"
                    alt=""
                    className="h-48 w-48 px-2"
                  />
                  <img
                    src="/freetimeideas/carrousel/3.jpg"
                    alt=""
                    className="h-48 w-48 px-2"
                  />
                </div>
              ...
              <div className="flex flex-col xl:w-1/2 lg:w-1/2 w-full items-center justify-center">
                <div className="bg-white py-3 px-3 my-3 mx-3 rounded-lg bg-opacity-50 border-2">
                  ...
                  <p className="text-justify">
                    ...
                    should change, it will build a wall between us and I will
                    not be happy with myself. As for who obeys who, I don't want
                    ...
                    that I am listening. I will try to let you know when I am
                    able to do everything that you expect or want me to do. I
                    will try to tell you why I can't do it, without feeling
                    guilty or angry. I will try to give you tenderness when we
                    are together even in those moments when something hurts us.
                    I will try to make it possible for you to do your own thing,
                    without putting limits on what you feel trapped in. Whenever
                    it is possible to do something together and we both want to
                    do it, let's do it. I'll try to have as much honesty with
                    you as I can give, and be that kind of person you can trust.
                    I need to laugh with you and spend time with you. When I
                    open my heart to you and tell you everything I feel, that
                    will be many times, like giving you a little newborn animal;
                    please take this with love and treat it very carefully. If
                    these words say something that is true for you too, let's
                    make a covenant and try to make it a reality.
                  </p>
                </div>
                <button
              ...
              <div className="flex flex-col xl:w-1/4 lg:w-1/4 w-full">
                <div className="flex flex-wrap h-full justify-center items-center">
                  <img
                    src="/freetimeideas/carrousel/4.jpg"
                    alt=""
                    className="h-48 w-48 px-2"
                  />
                  <img
                    src="/freetimeideas/carrousel/5.jpg"
                    alt=""
                    className="h-48 w-48 px-2"
                  />
                  <img
                    src="/freetimeideas/carrousel/6.jpg"
                    alt=""
                    className="h-48 w-48 px-2"
                  />
                </div>
